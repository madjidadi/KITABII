...
function buildNavbar() {
  ...
  conteneurNav.innerHTML = `
    <div class="nav-inner">
      <a href="index.html" class="logo">📖 Kitabi</a>
      <nav class="nav-links">
        <a href="index.html">Accueil</a>
        <a href="catalogue.html">Catalogue</a>
      </nav>
      <div class="nav-icons">
        <a href="favoris.html" class="icon-btn" title="Favoris">
        ...
        ${user
          ? `<a href="compte.html" class="btn-outline-sm">👤 ${user.nom}</a>
             <button onclick="doLogout()" class="btn-outline-sm" title="Déconnexion">↩</button>`
          : `<a href="connexion.html" class="btn-outline-sm">Se connecter</a>`
        }
      </div>
    </div>`;
